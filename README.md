...
| UNPKG    | ```<script src="https://unpkg.com/wikifox@1.0.2/dist/wikifox.js"></script>```            |
|----------|------------------------------------------------------------------------------------------|
| JSDELIVR | ```<script src="https://cdn.jsdelivr.net/npm/wikifox@1.0.2/dist/wikifox.js"></script>``` |
